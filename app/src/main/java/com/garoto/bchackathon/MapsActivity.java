package com.garoto.bchackathon;
...
import com.garoto.bchackathon.models.PlaceInfo;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Log.d(TAG, "onMapReady: map is ready :D");
        mMap = googleMap;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.map_layout_activity);
...
//        mPlaceAutoCompleteAdapter = new PlaceAutoCompleteAdapter()
        ...
        mInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.d(TAG, "onClick: clicked placed info");
                try {
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo) {
        ...
        if (placeInfo != null) {
            try {
                ...
                if (placeInfo.getRating() >= 3.5) {
                    snippet += "Sentimental Rating by Place " + placeInfo.getRating() + " \uD83D\uDE01";
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback = new ResultCallback<PlaceBuffer>() {
        ...
        public void onResult(@NonNull PlaceBuffer places) {
            if (!places.getStatus().isSuccess()) {
                Log.d(TAG, "onResult: Place query did not complete succefully" + places.getStatus().toString());
