...
public class Home extends AppCompatActivity {
    ...
    private void init() {
        Button btnMap = (Button) findViewById(R.id.mapaButton);
        Button btnComplaints = (Button) findViewById(R.id.complaintsButton);
        ...
        btnComplaints.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home.this, ComplaintsActivity.class);
                startActivity(intent);
            }
        });
